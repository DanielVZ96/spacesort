...
pub fn cribench_sorts_max_range(c: &mut Criterion) {
    ...
    let mut group = c.benchmark_group("sorts_space_max_range");
...
pub fn cribench_sorts_big_range(c: &mut Criterion) {
    ...
    let mut group = c.benchmark_group("sorts_space_big_range");
    let rng = Pcg64::from_seed([2;32]);
    let plot_config = PlotConfiguration::default()
        .summary_scale(AxisScale::Logarithmic);
    group.plot_config(plot_config);
...
pub fn cribench_sorts_med_range(c: &mut Criterion) {
    let mut group = c.benchmark_group("sorts_space_med_range");
    let plot_config = PlotConfiguration::default()
        .summary_scale(AxisScale::Logarithmic);
    group.plot_config(plot_config);
    let rng = Pcg64::from_seed([2;32]);
...
pub fn cribench_sorts_small_range(c: &mut Criterion) {
    let mut group = c.benchmark_group("sorts_space_small_range");
    let plot_config = PlotConfiguration::default()
        .summary_scale(AxisScale::Logarithmic);
    group.plot_config(plot_config);
    let rng = Pcg64::from_seed([2;32]);
...
pub fn cribench_sorts_tiny_range(c: &mut Criterion) {
    let mut group = c.benchmark_group("sorts_space_tiny_range");
    let plot_config = PlotConfiguration::default()
        .summary_scale(AxisScale::Logarithmic);
    group.plot_config(plot_config);
    let rng = Pcg64::from_seed([2;32]);
